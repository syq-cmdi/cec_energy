...
class Actor(nn.Module):
    ...
    def forward(self, state):
        ...
        x = F.relu(self.layer_norm1(self.layer1(state)))
        x = F.relu(self.layer_norm2(self.layer2(x)))
        x = F.relu(self.layer_norm3(self.layer3(x)))
...
class Critic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, hidden_dim=128):
        ...
        # 将批归一化替换为层归一化
        self.q1_layer_norm1 = nn.LayerNorm(hidden_dim)
        self.q1_layer_norm2 = nn.LayerNorm(hidden_dim)
        self.q1_layer_norm3 = nn.LayerNorm(hidden_dim // 2)
        ...
        # 将批归一化替换为层归一化
        self.q2_layer_norm1 = nn.LayerNorm(hidden_dim)
        self.q2_layer_norm2 = nn.LayerNorm(hidden_dim)
        self.q2_layer_norm3 = nn.LayerNorm(hidden_dim // 2)
    ...
    def forward(self, state, action):
        ...
        # Q1计算
        q1 = F.relu(self.q1_layer_norm1(self.q1_layer1(sa)))
        q1 = F.relu(self.q1_layer_norm2(self.q1_layer2(q1)))
        q1 = F.relu(self.q1_layer_norm3(self.q1_layer3(q1)))
        q1 = self.q1_layer4(q1)
        
        # Q2计算
        q2 = F.relu(self.q2_layer_norm1(self.q2_layer1(sa)))
        q2 = F.relu(self.q2_layer_norm2(self.q2_layer2(q2)))
        q2 = F.relu(self.q2_layer_norm3(self.q2_layer3(q2)))
